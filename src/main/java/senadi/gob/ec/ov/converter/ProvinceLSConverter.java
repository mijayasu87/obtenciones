 ...
 * @author michael
 */
@FacesConverter(value = "provinceLSConverter")
public class ProvinceLSConverter implements Converter{
    @Override
    public Object getAsObject(FacesContext ctx, UIComponent uiComponent, String idProvince) {
        ...
        return breederBean.getProvinceLSById(Integer.valueOf(idProvince));
    }
